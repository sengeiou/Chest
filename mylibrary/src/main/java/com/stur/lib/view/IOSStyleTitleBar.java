 ...
 */
public class IOSStyleTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    public IOSStyleTitleBar(Context context) {
        this(context, null);
    }

    public IOSStyleTitleBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IOSStyleTitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View.inflate(context, R.layout.view_ios_style_titlebar, this);
        initView();
        setListener();
