...
public class StDeviceActivity extends Activity {
	/** Called when the activity is first created. */

	private ListView mListView;
	private ArrayList<SiriListItem> list;
	private Button seachButton, serviceButton;
	StChatListAdapter mAdapter;
	Context mContext;
	...
	private void init() {
		...
		mAdapter = new StChatListAdapter(this, list);
		...
		serviceButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				StBluetoothActivity.serviceOrCilent= StBluetoothActivity.ServerOrCilent.SERVICE;
				StBluetoothActivity.mTabHost.setCurrentTab(1);
			}
		});
	}
	...
	private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
			...
			StBluetoothActivity.BlueToothAddress = address;
			...
			StopDialog.setPositiveButton("连接", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					...
					StBluetoothActivity.serviceOrCilent= StBluetoothActivity.ServerOrCilent.CILENT;
					StBluetoothActivity.mTabHost.setCurrentTab(1);
				}
			});
			StopDialog.setNegativeButton("取消",new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					StBluetoothActivity.BlueToothAddress = null;
				}
			});
			StopDialog.show();
		}
